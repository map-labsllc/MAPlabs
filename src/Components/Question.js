...
export default class Question extends React.Component {
  ...
  onChange = (e) => {
    console.log("Question::onChange(), e: ", e.target.value);
    this.setState({
      isDirty: true,
  ...
  onSubmit = (e) => {
    console.log(`Question::onclickSave(): ${this.state.answers}`);
...
// export default Question  // only neccessary for functional version
