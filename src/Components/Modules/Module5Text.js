...
<p>
Contemplate your Goals. The fourth and final core element of the definition of purpose is goal-orientation. You wrote your life purpose statement by articulating how you will use your meaning, desire, and strengths to serve something beyond yourself. You then articulated how you will commit to building your purpose through personal growth, relationships, and engagement mastery. Now it is time to become even more concrete through listing specific goals that will support a life centered on your purpose.
</p>
<p>
As you develop your goals here, try to write them in a way that is both (1) specific and (2) challenging. Organizational psychologists Edwin Locke and Gary Latham have studied goal- setting over many years and identified these as the two elements of goals that bring about the most dramatic results. And it makes intuitive sense. There is little use in striving for something if you cannot say what it is that you are striving for. And if you are not challenged, achieving the goal may not bringing out the very best in you—not to mention that achieving the goal would leave you in a position not very different from the one you started from. The idea recalls what we discussed in Module 3 about “flow,” the experience of rising to a challenge that brings us up to the outer limit of our strengths. Let your goal-setting create a context for you to experience flow on a daily basis.
</p>
<p>
</p>At the end of each module you were asked what you needed to break from and build to with regard to that module’s subject: feelings and experiences, values and beliefs, desires, and strengths. Review your responses about what you wanted break from and build toward.
<ol>
  <li>Do your responses feel accurate, authentic, comprehensive, and empowering to you? If so, feel free to leave them as they are. If not, revise, edit, or add new ones to them to more accurately reflect your current self-knowledge and understanding.</li>
  <li>Note which responses seem most critical to achieving your life purpose statement, and which seem secondary. If your responses seem to overlap, feel free to consolidate them. Then choose the most critical break from and build to goals that are necessary in
  order to support the achievement of your life purpose, and attach them to your final commitments on your dashboard.
  </li>
</ol>`

export const QUES_565_DESC = `
<p>
At the very beginning of the MAPmaker process you wrote a Future Desired Situation statement articulating what you most desired in your future. Now that you have completed nearly all of the MAPmaker program, it is time to revisit this statement to see how it stands up to the learning you have encountered. Reread the statement and make sure that it encompasses what you have learned through all five modules, and that it accurately reflects all of your understanding at this point. Does your description of your Future Desired Situation feel accurate, authentic, comprehensive, and empowering to you? If so, feel free to leave it as it is. If not, revise or edit it to more accurately reflect your current self-knowledge and understanding. Since this statement will now become part of your “quick-reference” dashboard, try to consolidate it down into a simple, to-the-point synopsis of only the most important concepts in a few sentences.
</p>
`
