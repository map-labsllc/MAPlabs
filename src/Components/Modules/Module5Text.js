...
<ul>
  ...
  <li>
  We can’t encourage you enough to keep up a regular journaling practice. Perhaps you could go back through the Dashboard linearly, journaling about each element sequentially over weeks so that you re-experience the key insights and discoveries of your MAPmaker journey each day. This could become a practice you return to periodically in order to always keep your life purpose journey fresh in your everyday life. And when you are not journaling about the entire journey, you could select the elements that seem most relevant to you on certain days, weeks, or months to focus on, using the Dashboard data to remind, inspire, and hold you accountable in the areas on which you are focusing during that time.
  </li>
  <li>
  Use the Dashboard to develop an  action plan to get from where you are today to where you want to be as an active engager in your life purpose. Many of us have worked with long-term planning models, whether in school, volunteer work, or our careers. If there is a model that has worked for you in the past, use that to frame the elements of the Dashboard so that you have a formal conception and framework against which you can act. If you do not have a model that you have previously used, feel free to improvise and create one that fits who you are and how you best operate. This will likely be a long-term, multi-year endeavor, so do not feel like you need to have every step perfectly articulated. But take on the elements that you know how to approach in the near-term, and return to your plan
  periodically to update it, using the Dashboard to help you to determine the elements of your next phases.
  </li>
</ul>
<p>These are just a few ways in which you can use the Dashboard to assist you in your ongoing life purpose development. In the future, we hope to add additional functionality to the MAPmaker platform that will leverage and extend the Dashboard data to assist users in their life purpose processes.
</p>
`
