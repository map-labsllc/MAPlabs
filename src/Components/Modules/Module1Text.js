...
export const QUES_110_DESC = 'A list of phrases is provided that are generalized statements about the feelings or experiences you may have in your current life.  From the list of phrases provided, choose only the ones that best describe the feelings or experiences you have in your <i>current situation</i> (we will get to your future desired situation later), especially the ones that are most relevant, provocative, or resonant to you.'

export const QUES_120_DESC = 'Using the phrases you chose, write a full description of your current state of mind, state of being, and general assessment of your current condition today as you begin MAPmaker.  Create this description in your own image, capturing how you feel, what you think of your situation, what is good and bad, and how you would describe your current self to your future self.  The goal of this exercise is not only to ground yourself in deep self-reflection and honesty, but also to give you a benchmark of your current condition that you can reference in the future.  So be as honest, thorough, and as descriptive as you can be.'

export const QUES_130_DESC = 'In this exercise you will follow essentially the same process as in Exercise 1.1.0, but this time you will focus on what you desire your future to be like, rather than on what your current situation is like. From the list of phrases provided, choose only the ones that best describe the <i>future state of being that you desire,</i> especially the ones that are most relevant, provocative, or resonant to you.'

export const QUES_140_DESC = 'Using the phrases you chose, write a full description of your future desired state of being.  Create this description in your own image capturing how you want to feel, what you will think of your future situation, what will be good and bad, and how you would describe your future self to your current self.  The goal of this exercise is to ground you in deep self-reflection about your future possibilities, and to give you a sense of your future aspirations and how your future can differ from your current condition.  So be as honest, thorough, and descriptive as you can be.'

export const QUES_150_DESC = 'Review and compare the statement from Exercise 1.2.0 to the statement from Exercise 1.4.0.  Look for ways in which the two statements reflect each other, and for ways in which they reflect differing things from each other, and record in the space below.'

export const QUES_160_DESC = `Now let’s make this very concrete. Consider what needs to be "broken from" in your current situation and what needs to be "built toward" to create your desired future life. Fill in the following blanks with your responses.
<br><br>
