...
export const QUES_120_DESC = `Using the phrases you chose, as well as the descriptions you created next to each one of them, write a full description of your current state of mind, state of being, and general assessment of your current condition today as you begin MAPmaker.  Create this description in your own image, capturing how you feel, what you think of your situation, what is good and bad, and how you would describe your current self to your future self.  The goal of this exercise is not only to ground yourself in deep self-reflection and honesty, but also to give you a benchmark of your current condition that you can reference in the future.  So be as honest, thorough, and as descriptive as you can be.`


export const QUES_130_DESC = `Today you will do essentially the same exercise you did yesterday, but this time you will focus on what you desire your future to be like, rather than on what your current situation is like. From the list of phrases provided in the workbook, choose the ones that seem to best describe the <i>future state of being that you desire</>, especially the ones that are most relevant, provocative, or resonant to you.`
