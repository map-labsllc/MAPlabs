...
<br><br>
Within each category, compare the desires you listed, and make a tradeoff between each set of two, choosing only one of the two desires to carry into the next round.  Then do the same for desires three and four, etc… At the end of round 1 you will have culled your desires in this category from ten to five.  Then do the same in the next round, and so on, until you only have one primary desire within the category.  Do this exercise for each of the categories until you only have one primary desire for each category.
<br><br>
...
export const QUES_330_DESC = 'Now that you have distilled your desires to what is most important to you within each category, it is time to compare and prioritize between the categories themselves. The process here works the same way as the previous tradeoffs, but here we get to compare parts of our lives that are distinct and decide what role and proportion they each have in our lives. Again, you will make tradeoffs between the final desires of each of the categories until only one desire remains.'
...
export const QUES_360_DESC = `In order to create more personal Autonomy, consider which desires are less authentic and need to be "broken from," and which desires are more authentic and need to be "built toward." Fill in the following blanks with your responses.
<br><br>
