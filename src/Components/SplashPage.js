...
const SplashPage = () => {
    return (
        <div style={style.background}>
            ...
            <h5 style={style.textMargin}>
At MAPlabs, we turn the latest scientific findings on human meaning and purpose into programs that inform, empower, and fulfill human lives.
